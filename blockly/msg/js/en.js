...
Blockly.Msg.CASES_TIP = "Does something if the condition is true. If there is not a matching case the default function will be executed.";
...
Blockly.Msg.SMILE_LED_BRIGHT = "Set brightness to";
Blockly.Msg.SMILE_LED_FADE = "Fade LED";
Blockly.Msg.SMILE_LED_FADE_FROM = "from";
Blockly.Msg.SMILE_LED_FADE_SEC = "seconds";
Blockly.Msg.SMILE_LED_FADE_TO = "to";
Blockly.Msg.SMILE_LED_INIT_INIT = "Connect";
Blockly.Msg.SMILE_LED_INIT_PIN = "LED(s) at Pin";
Blockly.Msg.SMILE_LED_SET = "Set LED";
Blockly.Msg.SMILE_OPENWEATHERMAP_APIKEY = "with API-Key";
Blockly.Msg.SMILE_OPENWEATHERMAP_DROPDOWN_ID = "WeatherID";
Blockly.Msg.SMILE_OPENWEATHERMAP_DROPDOWN_TEMP = "Temperature";
Blockly.Msg.SMILE_OPENWEATHERMAP_FOR = "for";
